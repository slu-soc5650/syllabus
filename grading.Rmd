...
```{block, type = "rmdtip"}
Labs are worth **28%** of your final grade.
```
...
```{block, type = "rmdtip"}
The final project is worth, in total, **62%** of your final grade. The waypoints are worth **28%** of your final grade, and the final deliverables are worth **34%** of your final grade. Deliverables vary by section; see below for details.
```
...
final4015 <- data.frame(
  Assignment = c("Waypoints", "Final Code & Docs", "Final Storymap", "Final Handout"),
  Points = c("20 pts", "70 pts", "70 pts", "30 pts"),
  Quantity = c("x7", "x1", "x1", "x1"),
  Total = c("140 pts", "70 pts", "70 pts", "30 pts"),
...
```{r, echo=FALSE}
final4015 <- data.frame(
  Assignment = c("Waypoints", "Annotated Bibliography", "Final Code & Docs", "Final Storymap", "Final Handout", "Final Paper"),
  Points = c("20 pts", "25 pts", "40 pts", "40 pts", "25 pts", "40 pts"),
  Quantity = c("x7", "x1", "x1", "x1", "x1", "x1"),
  Total = c("140 pts", "25 pts", "40 pts", "40 pts", "25 pts", "40 pts"),
  stringsAsFactors = FALSE
)
