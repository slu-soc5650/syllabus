...
Select a module from the menu to see details about topics, readings, and assignments. Additional notes and links to course materials are available through <a href="https://canvas.slu.edu" target="_blank">Canvas</a>, which has dedicated folders for each module and Meeting.



## Module 1 - Getting Started {-}

### Meeting 1-1 - Monday, January 24 - Course Introduction {-}

* **Before Class:**
  * Complete the Course Onboarding tasks (see <a href="https://canvas.slu.edu" target="_blank">Canvas</a> - Modules > Course Onboarding)
  * Complete the Meeting 01 preparatory readings, videos, and entry ticket 
    ...
    * Entry Ticket 1-1 (<a href = "https://docs.google.com/forms/d/e/1FAIpQLSfI66TDRFH6xsj7getQZ3UXo8d7JeiMaCNH0WOhJZcXcevx7g/viewform?usp=sf_link" target = "_blank">Link</a>)

* **After Class:** 
  * Complete Lab 1-1 - A Simple Interactive Map (<a href="https://www.github.com/slu-soc5650/module-1-intro" target="_blank">GitHub</a>)
  * Read through the Final Project instructions (<a href="https://slu-soc5650.github.io/final-project/topic-data-selection.html" target="_blank">Link</a>) and draft your initial memo (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
...
### Meeting 1-2 - Monday, January 31 - Map Production Basics {-}

* **Before Class:**
  * **_From prior meetings:_**
    * Complete Lab 1-1 from last week
  * **_For this meeting:_**
    * Prep Video A - Analysis Development (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
    * Prep Video B - Cartography Basics (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
    * Read through the Final Project instructions (<a href="https://slu-soc5650.github.io/final-project/topic-data-selection.html" target="_blank">Link</a>) and draft your initial memo (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
    * Entry Ticket 1-2 (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)

* **After Class:**
  * Complete Lab 1-2 (<a href="https://www.github.com/slu-soc5650/module-1-basics" target="_blank">GitHub</a>)
...
### Meeting 1-3 - Monday, February 7 - Cartography 101 {-}

* **Before Class:**
  * **_From prior meetings:_**
    * Complete Lab 1-2 from last week
  * **_For this meeting:_**
    * Prep Video A - Visual Contrast (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
    * Prep Video B - Color Theory (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
    * Prep Video C - Working with Color (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
    * Brewer, *Designing Better Maps*, Chapters 7 and 8
    * Entry Ticket 1-3 (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
 
 * **After Class:**
   * Complete Lab 1-3 (<a href="https://www.github.com/slu-soc5650/module-1-cartography" target="_blank">GitHub</a>)
  
## Module 2 - Data Cleaning {-}

### Meeting 2-1 - Monday, February 14 - Data Cleaning Basics {-}

* **Before Class:**
  * **_From prior meetings:_**
    * Complete Lab 1-3 from last week
  * **_For this meeting:_**
    * Prep Video A - Types of Data and Levels of Measurement (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
    * Prep Video B - Tidy Data (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
    * Prep Video C - Verbs for Data Cleaning (1) (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
    * Prep Video D - Verbs for Data Cleaning (2) (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
    * Brewer, *Designing Better Maps*, Chapter 1, pp 1-6
    * Entry Ticket 2-1 (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
  
 * **After Class:**
   * Complete Lab 2-1 (<a href="https://www.github.com/slu-soc5650/module-2-data-cleaning" target="_blank">GitHub</a>)
   * Final Project WP-2 - Data Cleaning (due in two meetings; GitHub)

---

### Meeting 2-2 - Monday, February 21 - Combining Data Sources {-}

* **Before Class:**
  * **_From prior meetings:_**
    * Complete Lab 2-1 from last week
  * **_For this meeting:_**
    * Prep Video A - Table Joins (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
    * Prep Video B - Census Geography (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
    * Prep Video C - Census TIGER/Line Data (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
    * Prep Video D - Census Demographic Data (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
    * Brewer, *Designing Better Maps*, Chapter 1, pp 6-16 
    * Entry Ticket 2-2 (<a href="https://canvas.slu.edu" target="_blank">Canvas</a>)
 
 * **After Class:**
   * Complete Lab 2-2 (<a href="https://www.github.com/slu-soc5650/module-2-combine-sources" target="_blank">GitHub</a>)
   * Final Project WP-2 - Data Cleaning
   * Final Project WP-3 - Combining Data Sources (due in two meetings) 
   * Final Project WP-G1 - Annotated Bibliography (due next week; SOC 5650 students only; <a href="https://canvas.slu.edu" target="_blank">Canvas</a>)

## Module 3 - Geoprocessing {-}

### Meeting 3-1 - Monday, February 28 - Working with Map Projections {-}
...
* **After Class:**
   * Complete Lab 3-1 (<a href="https://www.github.com/slu-soc5650" target="_blank">GitHub</a>)
   * Final Project WP-3 - Combining Data Sources
   * Final Project WP-4 - Projecting Data (due in two meetings)

---

### Meeting 3-2 - Monday, March 7 - Intersect, Select, and Aggregate {-}
...
* **After Class:**
   * Complete Lab 3-2 (<a href="https://www.github.com/slu-soc5650" target="_blank">GitHub</a>)
   * Final Project WP-4 - Projecting Data
   
---

### Meeting 3-3 - Monday, March 21 - Bind, Dissolve, and Process {-}
...
* **After Class:**
   * Complete Lab 3-3 (<a href="https://www.github.com/slu-soc5650" target="_blank">GitHub</a>)
   * Final Project WP-5 - Geoprocessing (due in two meetings)

## Module 4 - Map Products {-}

### Meeting 4-1 - Monday, March 28 - ArcGIS Online {-}
...
* **After Class:**
   * Complete Lab 4-1 (<a href="https://www.github.com/slu-soc5650" target="_blank">GitHub</a>)
   * Final Project WP-5 - Geoprocessing

---

### Meeting 4-2 - Monday, April 4 - Story Maps, Part 1 {-}
...
* **After Class:**
   * Complete Lab 4-2 (<a href="https://www.github.com/slu-soc5650" target="_blank">GitHub</a>)
   * Final Project WP-G2 - Draft Paper (SOC 5650 students only)

---

### Meeting 4-3 - Monday, April 11 - Story Maps, Part 2 {-}
...
* **After Class:**
   * Complete Lab 4-3 (<a href="https://www.github.com/slu-soc5650" target="_blank">GitHub</a>)
   * Final Project WP-G3 - Peer Review (SOC 5650 students only; due **Wednesday, April 20**)
   * Final Project WP-6 - Draft Story Map 

---

### Meeting 4-4 - Monday, April 25 - Print Maps, Part 1 {-}
...
* **After Class:**
   * Complete Lab 4-4 (<a href="https://www.github.com/slu-soc5650" target="_blank">GitHub</a>)

---

### Meeting 4-5 - Monday, May 2 - Print Maps, Part 2 {-}
...
* **After Class:**
   ...
   * Complete all remaining final project steps (due **Monday, May 16**)
