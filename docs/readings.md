...
* Tutorial: Chapter 2, *part*, pp. xx-xx
...
* Tutorial: 
    * Chapter 2, *part*, pp. xx-xx
    * Chapter 3, *part*, pp. xx-xx
...
* **Data Visualization** - Mapping with `R`
...
## Lecture-06 - Communicating with Maps {-}
...
* Tutorial: Chapter 3, *part*, pp. xx-xx
...
* *From Lecture-05* - PS-02 - Map Production in `R`
* *From Lecture-06* - Lab-05 - Creating Map Products
* eTicket-07
...
* Tutorial: Chapter 4, *part*, pp. xx-xx
...
* Tutorial: Chapter 6, *part*, pp. xx-xx
...
* Tutorial: Chapter 7, *part*, pp. xx-xx
* Tutorial: Chapter 10, *part*, pp. xx-xx
...
* Tutorial: Chapter 8, *part*, pp. xx-xx
...
* Tutorial: Chapter 9, *part*, pp. xx-xx
